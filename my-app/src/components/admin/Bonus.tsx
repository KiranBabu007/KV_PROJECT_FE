...
} from "@/api-service/bonus/bonus.api";
...
const BonusManagement: React.FC = () => {
  ...
  const [recentlyPaidBonus, setRecentlyPaidBonus] = useState<Bonus | null>(
    null
  );
  ...
  const totalBonusesDue =
    bonuses?.reduce(
      (sum, bonus) =>
        bonus.bonusStatus === "DUE" ? sum + (bonus.bonusAmount || 0) : sum,
      0
    ) || 0;
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {showAlert && recentlyPaidBonus && (
          <Alert className="bg-green-50 border-green-200 text-green-800 animate-fade-in shadow-lg">
            ...
            <AlertDescription>
              Bonus payment of ₹{recentlyPaidBonus.bonusAmount.toLocaleString()}{" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-700">
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <p>
                    Bonuses become eligible 6 months after the referred
